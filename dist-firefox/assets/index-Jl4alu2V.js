...
class LinkLibraryDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      links: "++id,folderId,title,url,favorite,createdAt,updatedAt,*tags"
    });
  }
}
const db = new LinkLibraryDB();
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          label && /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: label }),
          ...
          `,
              children: [
                leftIcon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-3 text-gray-400", children: leftIcon }),
            ...
            `,
                ...
                clearable && value && !disabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: onClear,
                ...
                !isPassword && rightIcon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pr-3 text-gray-400", children: rightIcon })
              ]
            }
          ),
          error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600", children: error }) : helperText ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: helperText }) : null
        ]
      }
    );
  }
...
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      ...props,
      children: [
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : leftIcon,
...
function useFolders() {
  ...
  const loadFolders = reactExports.useCallback(async () => {
    try {
      setLoading(true);
      const data = await db.folders.orderBy("name").toArray();
      setFolders(data);
      setError(null);
    } catch (err) {
      console.error(err);
  ...
  const createFolder = reactExports.useCallback(
    async (input) => {
  ...
  const updateFolder = reactExports.useCallback(
    async (id, updates) => {
  ...
  const moveFolder = reactExports.useCallback(
  ...
  const deleteFolder = reactExports.useCallback(
    async (id) => {
...
function FolderSelector({
  ...
  const flattenedFolders = reactExports.useMemo(() => {
    const result = [];
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-full animate-pulse rounded-lg bg-gray-100" });
  }
  if (folders.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700", children: "Folder" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-red-200 bg-red-50 p-2.5 text-xs text-red-600 font-medium", children: "Create a folder first." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "folder-selector", className: "text-sm font-medium text-gray-700", children: [
      "Folder ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        `,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, children: "Select a folder..." }),
          flattenedFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: folder.id, children: "  ".repeat(folder.depth) + folder.name }, folder.id))
        ]
      }
    ),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 mt-1", children: error })
  ] });
}
...
function LinkForm({
  ...
  const [title, setTitle] = reactExports.useState(initialValues.title);
  const [url, setUrl] = reactExports.useState(initialValues.url);
  const [description, setDescription] = reactExports.useState(initialValues.description);
  const [tags, setTags] = reactExports.useState(initialValues.tags.join(", "));
  const [folderId, setFolderId] = reactExports.useState(initialValues.folderId);
  const [favorite, setFavorite] = reactExports.useState(initialValues.favorite);
  ...
  function validate() {
    ...
    if (folderId === void 0 || isNaN(folderId) || folderId <= 0) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "link-description", className: "mb-1 block text-sm font-medium text-gray-700", children: "Description" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          id: "link-description",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "link-favorite", className: "text-sm font-medium text-gray-700 cursor-pointer select-none", children: "Add to Favorites" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "ghost", onClick: onCancel, children: "Cancel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", loading, children: "Save Link" })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        `,
          children: [
            title && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b px-5 py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  id: "modal-title",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[70vh] overflow-y-auto px-5 py-4", children }),
            footer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end gap-3 border-t px-5 py-4", children: footer })
          ]
        }
      )
    }
...
function useLinks() {
  ...
  const [loading, setLoading] = reactExports.useState(true);
  const [error, setError] = reactExports.useState(null);
  const loadLinks = reactExports.useCallback(async () => {
    try {
      setLoading(true);
      const data = await db.links.orderBy("createdAt").reverse().toArray();
      setLinks(data);
      setError(null);
    } catch (err) {
      console.error(err);
  ...
  const createLink = reactExports.useCallback(
    async (input) => {
      const now = /* @__PURE__ */ new Date();
      await db.links.add({
        ...input,
  ...
  const deleteLink = reactExports.useCallback(
    async (id) => {
  ...
  const filteredLinks = reactExports.useMemo(() => {
    ...
    if (query) {
      result = result.filter((link) => {
        return link.title.toLowerCase().includes(query) || link.url.toLowerCase().includes(query) || (link.description ?? "").toLowerCase().includes(query) || link.tags.some(
